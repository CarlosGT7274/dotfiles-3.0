...
launch_bars() {
	...
	for mon in $(polybar --list-monitors | cut -d":" -f1); do
		(MONITOR=$mon polybar --reload pam1 ) &
		(MONITOR=$mon polybar --reload pam2 ) &
		(MONITOR=$mon polybar --reload pam3 ) &
		(MONITOR=$mon polybar --reload pam4 ) &
		(MONITOR=$mon polybar --reload pam5 ) &
		(MONITOR=$mon polybar --reload pam6 ) &
	done
